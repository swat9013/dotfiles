...
**判断基準 reference**:
- `references/tuning-guide.md` — 8分類の修正パターンテーブル
...
`references/tuning-guide.md` の8分類テーブルを Read し、Step 1 で特定した対象ファイルを Read して仮説を生成する。
...
## 追記候補（domain-model.md）
[Step 2 で記録した追記候補、またはなし]
```
