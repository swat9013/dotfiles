...
- `description`: コマンドの説明（`(project)` タグ推奨）

### 基本テンプレート

```yaml
---
description: コミットメッセージを生成してコミット実行 (project)
---
```
...
```yaml
---
description: 指定したファイルをリファクタリング (project)
---

# /refactor $ARGUMENTS

使用方法: `/refactor <file_path>`

$ARGUMENTS で指定されたファイルをリファクタリングします。
```
...
- [ ] Commands: `description:` が存在するか
- [ ] Agents: `name:` と `description:` が存在するか
