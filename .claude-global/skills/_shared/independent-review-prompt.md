...
- `§2.2`（Architecture Fitness Harness 三項組）を主目的関数として Read する
- `§2.1` の境界条件のみ Read し侵食禁止制約とする

**レビュー対象がアプリケーションコードの場合**:
- `§2.1`（Maintainability Harness 三項組）を主目的関数として Read する
- `§2.2` の境界条件のみ Read し侵食禁止制約とする
