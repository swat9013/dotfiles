---
name: glab
description: GitLab CLI（glab）の操作ガイド。コマンド仕様、MR・Issue・CI/CD・リポジトリ操作を含む。「glab」「GitLab CLI」「GitLab MR」「Merge Request」「GitLab issue」「GitLab CI」「GitLab パイプライン」「glab mr」「glab ci」と依頼された時に参照する。
